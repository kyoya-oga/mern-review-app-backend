...
exports.validateMovie = [
  ...
  check('storyLine')
    ...
    .not()
    .isEmpty()
    .withMessage('Movie storyline is missing!'),
  check('releaseDate').custom((value) => {
    if (!value && validator.isISO8601(value.toISOString())) {
    ...
    .custom((cast) => {
      for (let c of cast) {
        ...
        if (typeof c.leadActor !== 'boolean') {
          throw Error('Only accepted boolean value inside lead actor');
        }
        return true;
      }
    }),
